...
module.exports = {
    ...
    'asset-db-debugger:open': function () {
        Editor.Panel.open('asset-db-debugger.panel');
    },

    'asset-db-debugger:query-url-uuid': function ( reply ) {
        var results = [];
    ...
    'asset-db-debugger:query-uuid-url': function ( reply ) {
        var results = [];
    ...
    'asset-db-debugger:query-url-subuuids': function ( reply ) {
        var results = [];
